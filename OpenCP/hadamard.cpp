...
void Hadamard1D4(float *val)
{
    ...
    __attribute__ ((aligned(16))) float sign[2][4] = { { 1.0f, -1.0f, 1.0f, -1.0f }, { 1.0f, 1.0f, -1.0f, -1.0f } };
...
void Hadamard1D8(float *val)
{
    ...
    __attribute__ ((aligned(16))) float sign0[4] = { 1.0f, -1.0f, 1.0f, -1.0f };
    __attribute__ ((aligned(16))) float sign1[4] = { 1.0f, 1.0f, -1.0f, -1.0f };
...
void Hadamard2D8x8i(float *vall)
{
	...
	float* src = vall;
    {
        __attribute__ ((aligned(16))) float temp[16];
		__m128 m0 = _mm_load_ps(src);
