...
static Scalar sScaller=Scalar::all(200);
void drawHistogramImageGray(cv::InputArray src, cv::OutputArray histogram, cv::Scalar color, cv::Scalar color2, bool isGrid)
{
	...
	if (isGrid)
	{
        drawGrid(hist_img, Point(hist_img.cols / 2, hist_height / 2), sScaller, 2);
        drawGrid(hist_img, Point(hist_img.cols / 4, hist_height / 2), sScaller, 1);
        drawGrid(hist_img, Point(hist_img.cols * 3 / 4, hist_height / 2), sScaller, 1);
        drawGrid(hist_img, Point(hist_img.cols / 2, hist_height * 1 / 4), sScaller, 1);
        drawGrid(hist_img, Point(hist_img.cols / 2, hist_height * 3 / 4), sScaller, 1);
	}
