...
struct sii_coeffs
{
    __attribute__ ((aligned(16))) T weights[SII_MAX_K];     /**< Box weights     */
    __attribute__ ((aligned(16))) int radii[SII_MAX_K];      /**< Box radii       */
...
{
    __attribute__ ((aligned(16))) T a[DERICHE_MAX_K + 1];             /**< Denominator coeffs          */
    __attribute__ ((aligned(16))) T b_causal[DERICHE_MAX_K];          /**< Causal numerator            */
    __attribute__ ((aligned(16))) T b_anticausal[DERICHE_MAX_K + 1];  /**< Anticausal numerator        */
...
struct vyv_coeffs
{
    __attribute__ ((aligned(16))) T filter[VYV_MAX_K + 1];     /**< Recursive filter coefficients       */
    __attribute__ ((aligned(16))) T M[VYV_MAX_K * VYV_MAX_K];  /**< Matrix for handling right boundary  */
	T sigma;                     /**< Gaussian standard deviation         */
	T tol;                       /**< Boundary accuracy                   */
	int K;                         /**< Filter order                        */
